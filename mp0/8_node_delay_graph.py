...
def process():
    f = open("8_node_delay_data.txt", "r")
    line = f.readline()
...
def delay_time_plot_min(delay_dic):
    ...
    plt.title('Min Delay vs. time plot for 8 Nodes')
    plt.xlabel('Time in seconds')
    plt.ylabel('Delay in seconds')
    plt.legend()
    plt.savefig("8_node_min_delay_time_graph.png", format="PNG", bbox_inches='tight')
...
def delay_time_plot_max(delay_dic):
    ...
    plt.title('Max Delay vs. time plot for 8 Nodes')
    plt.xlabel('Time in seconds')
    plt.ylabel('Delay in seconds')
    plt.legend()
    plt.savefig("8_node_max_delay_time_graph.png", format="PNG", bbox_inches='tight')
...
def delay_time_plot_med(delay_dic):
    ...
    plt.title('Median Delay vs. time plot for 8 Nodes')
    plt.xlabel('Time in seconds')
    plt.ylabel('Delay in seconds')
    plt.legend()
    plt.savefig("8_node_med_delay_time_graph.png", format="PNG", bbox_inches='tight')
...
def delay_time_plot_90(delay_dic):
    ...
    plt.title('90% Delay vs. time plot for 8 Nodes')
    plt.xlabel('Time in seconds')
    plt.ylabel('Delay in seconds')
    plt.legend()
    plt.savefig("8_node_90_delay_time_graph.png", format="PNG", bbox_inches='tight')
