...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  ConnectResponse Connect(ConnectRequest req)")
  fmt.Fprintln(os.Stderr, "  PrepareResponse Prepare(PrepareRequest req)")
  fmt.Fprintln(os.Stderr, "  ConfirmResponse Confirm(ConfirmRequest req)")
  fmt.Fprintln(os.Stderr, "  BeginResponse Begin(BeginRequest req)")
  fmt.Fprintln(os.Stderr, "  ExecuteResponse Execute(ExecuteRequest req)")
  fmt.Fprintln(os.Stderr, "  CommittableResponse Committable(CommittableRequest req)")
  fmt.Fprintln(os.Stderr, "  CommitResponse Commit(CommitRequest req)")
  fmt.Fprintln(os.Stderr, "  AbortResponse Abort(AbortRequest req)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := rpc.NewTransactionServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "Connect":
    ...
    argvalue0 := rpc.NewConnectRequest()
  ...
  case "Prepare":
    ...
    argvalue0 := rpc.NewPrepareRequest()
    ...
    value0 := argvalue0
    fmt.Print(client.Prepare(context.Background(), value0))
    fmt.Print("\n")
    break
  case "Confirm":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "Confirm requires 1 args")
      flag.Usage()
    }
    arg46 := flag.Arg(1)
    ...
    argvalue0 := rpc.NewConfirmRequest()
    ...
    value0 := argvalue0
    fmt.Print(client.Confirm(context.Background(), value0))
    fmt.Print("\n")
    break
  case "Begin":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "Begin requires 1 args")
      flag.Usage()
    }
    arg52 := flag.Arg(1)
    ...
    value0 := argvalue0
    fmt.Print(client.Begin(context.Background(), value0))
    fmt.Print("\n")
    break
  case "Execute":
    if flag.NArg() - 1 != 1 {
    ...
    argvalue0 := rpc.NewExecuteRequest()
  ...
  case "Committable":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "Committable requires 1 args")
      flag.Usage()
    }
    arg64 := flag.Arg(1)
    ...
    argvalue0 := rpc.NewCommittableRequest()
    ...
    value0 := argvalue0
    fmt.Print(client.Committable(context.Background(), value0))
    fmt.Print("\n")
    break
  case "Commit":
    if flag.NArg() - 1 != 1 {
    ...
    argvalue0 := rpc.NewCommitRequest()
    ...
    value0 := argvalue0
    fmt.Print(client.Commit(context.Background(), value0))
    fmt.Print("\n")
    break
  case "Abort":
    if flag.NArg() - 1 != 1 {
    ...
    value0 := argvalue0
    fmt.Print(client.Abort(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
