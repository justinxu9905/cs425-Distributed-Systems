...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  bool DeliverTx(string op, string act1, string act2, i64 amt)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := rpc.NewTxSvrClient(thrift.NewTStandardClient(iprot, oprot))
	...
	case "DeliverTx":
		if flag.NArg()-1 != 4 {
			fmt.Fprintln(os.Stderr, "DeliverTx requires 4 args")
			flag.Usage()
		}
		...
		value3 := argvalue3
		fmt.Print(client.DeliverTx(context.Background(), value0, value1, value2, value3))
		fmt.Print("\n")
		break
	case "":
		Usage()
